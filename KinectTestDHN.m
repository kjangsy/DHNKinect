...
%% Data Read
orig_data = dlmread('shake_1t.txt', '\t');
...
%     
%     idx = (i - 1) * 4;
%     titleStr = sprintf('Joint %d', i);
%     
%     subplot(2,2,1);
%     hold on;
%     plot(data(1:100, idx + 1), 'r--');
%     plot(gen_seq(1:100, idx + 1), 'b');
%     title(titleStr);
...
%     subplot(2,2,2);
%     hold on;
%     plot(data(1:100, idx + 2), 'r--');
%     plot(gen_seq(1:100, idx + 2), 'b');
%     title(titleStr);
%     legend('Original', 'Generated');
%     xlabel('frames');
%     ylabel('y');
...
%     subplot(2,2,3);
%     hold on;
%     plot(data(1:100, idx + 3), 'r--');
%     plot(gen_seq(1:100, idx + 3), 'b');
%     title(titleStr);
%     legend('Original', 'Generated');
%     xlabel('frames');
%     ylabel('z');
...
%     subplot(2,2,4);
%     hold on;
%     plot(data(1:100, idx + 4), 'r--');
%     plot(gen_seq(1:100, idx + 4), 'b');
%     title(titleStr);
%     legend('Original', 'Generated');
%     xlabel('frames');
%     ylabel('w');
%     
%     fileName = strcat(titleStr, '.jpg');
%     
...
%     subplot(1,2,j);
%     hold on;
%     plot(data(1:100,i * 4), 'r--');
%     plot(gen_seq(1:100,i * 4), 'b');
